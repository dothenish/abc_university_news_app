/*=====================================================
* Program: add_news_page.dart
* Purpose: Display the bookmarked/favorited news articles
* Notes: have image package to select image from device's gallery, have form validation
*======================================================
*/
...
//form global key for validation/managing state
final _formKey = GlobalKey<FormState>();

class AddNewsPage extends StatefulWidget {
  final Function(News) onNewsAdded; //invoke this callback function when news is added
...
class _AddNewsPageState extends State<AddNewsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      leading: IconButton(
        ...
        body: SingleChildScrollView( //handle screen overflow
        child: Padding(
  ...
  //container to display selected image from gallery
